...
"[project]/node_modules/php-serialize/lib/esm/parser.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/php-serialize/lib/esm/helpers.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/php-serialize/lib/esm/unserialize.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/php-serialize/lib/esm/parser.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/php-serialize/lib/esm/helpers.js [app-route] (ecmascript)");
...
function getClassReference(className, scope, strict) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invariant"])(classReference || !strict, "Class " + className + " not found in given scope");
    if (classReference) {
        // @ts-ignore
        container = new ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClass"])(classReference.prototype))();
    } else {
        container = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIncompleteClass"])(className);
    }
    return container;
}
...
function unserializeItem(parser, scope, options) {
    ...
    if (type === 'array-object') {
        ...
        var isArray = pairs.every(function(item, idx) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isInteger"])(item.key) && idx === item.key;
        });
    ...
    if (type === 'serializable-class') {
        ...
        if (!(result instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["__PHP_Incomplete_Class"])) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invariant"])(result.unserialize, "unserialize not found on class when processing '" + name + "'");
...
function unserialize(item, scope, givenOptions) {
    ...
    var parser = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](Buffer.from(item), 0, options);
    return unserializeItem(parser, scope, options);
}
const __TURBOPACK__default__export__ = unserialize;
}),
"[project]/node_modules/php-serialize/lib/esm/serialize.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function serialize(item, scope, givenOptions) {
    ...
    if (type === 'number' || type === 'bigint') {
        if (typeof item === 'bigint' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isInteger"])(item)) {
            return "i:" + item + ";";
        }
        return "d:" + item.toString().toUpperCase() + ";";
    }
    if (type === 'string') {
        return "s:" + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getByteLength"])(item, options) + ":\"" + item + "\";";
    }
    if (type === 'boolean') {
        return "b:" + (item ? '1' : '0') + ";";
    }
    ...
    if (typeof item.serialize === 'function') {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invariant"])(typeof serialized === 'string', item.constructor.name + ".serialize should return a string");
        return "C:" + constructorName.length + ":\"" + constructorName + "\":" + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getByteLength"])(serialized, options) + ":{" + serialized + "}";
    }
    return "O:" + constructorName.length + ":\"" + constructorName + "\":" + serializeObject(item, scope);
}
}),
"[project]/node_modules/php-serialize/lib/esm/isSerialized.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/php-serialize/lib/esm/index.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$unserialize$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/php-serialize/lib/esm/unserialize.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$serialize$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/php-serialize/lib/esm/serialize.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$isSerialized$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/php-serialize/lib/esm/isSerialized.js [app-route] (ecmascript)");
;
;
;
;
}),
"[project]/node_modules/php-serialize/lib/esm/serialize.js [app-route] (ecmascript) <export default as serialize>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "serialize",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$serialize$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$php$2d$serialize$2f$lib$2f$esm$2f$serialize$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/php-serialize/lib/esm/serialize.js [app-route] (ecmascript)");
}),
];

//# sourceMappingURL=node_modules_1b993637._.js.map